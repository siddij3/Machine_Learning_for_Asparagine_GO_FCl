...
def importData(data, scaler):
    ...
    train_dataset = data.sample(frac=0.7, random_state=1234)
...
path = "Sum 32 - Fold 400  - NEW - Shortened Data\\"
optimal_NNs_mae = [
    load_model(f'{path}Model [22, 6] number 0'), 
    load_model(f'{path}Model [22, 6] number 1'), 
    load_model(f'{path}Model [22, 6] number 2'), 
    load_model(f'{path}Model [22, 6] number 3') ]
